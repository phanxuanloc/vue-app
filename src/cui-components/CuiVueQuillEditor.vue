<template>
  <div class="ui-block">
    ...
    <h4 class="ui-block-heading" v-if="!isIE10">Examples</h4>

    <div class="cui-example cui-example-vertical-spacing" v-if="!isIE10">
...
export default {
  ...
  data: () => ({
    ...
    isIE10: typeof document.documentMode === 'number' && document.documentMode === 10
  })
}
</script>
