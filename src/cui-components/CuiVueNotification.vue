<template>
  <div class="ui-block">
    <h3 class="ui-block-heading">vue-notification</h3>
    <a target="_blank" href="https://github.com/euvl/vue-notification" class="ui-block-description">https://github.com/euvl/vue-notification</a>
