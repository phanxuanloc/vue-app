<template>
  <div>
    ...
    <div v-for="section in sectionsData">
      <b-card no-body class="mb-3">
        ...
        <div v-for="(forum, index) in section.forums">
                ...
                <div class="row no-gutters align-items-center">
                  ...
                  <div class="col-6">
                    <div v-if="forum.lastUpdate" class="media align-items-center">
                      <img :src="`/static/img/avatars/${forum.lastUpdate.user.avatar}`" alt="" class="d-block ui-w-30 rounded-circle">
