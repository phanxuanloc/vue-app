    ...
    <div class="row">
      <div class="col">
        ...
        <b-card v-if="projectData.attachments && projectData.attachments.length" header="Attached files" header-tag="h6" body-class="p-3" class="mb-4">
          <div class="row no-gutters">
            <div v-for="attachment in projectData.attachments" class="col-md-6 col-lg-12 col-xl-6 p-1">

              <div class="project-attachment ui-bordered p-2">
                <div v-if="isImage(attachment)" :style="{'background-image': `url(${attachment.path})`}" class="project-attachment-img"></div>
        ...
        <b-tabs class="nav-tabs-top mb-4">
          <b-tab title="Tasks" active>
            ...
            <div v-for="(section, index) in projectData.taskSections">
              <b-card-body>
                ...
                <draggable v-model="section.tasks" :options="draggableOptions" class="project-task-list custom-controls-stacked">
                  ...
                  <div v-for="task in section.tasks" class="project-task-item">
                    ...
                    <label class="ui-todo-item custom-control custom-checkbox">
                      ...
                      <span v-if="task.tags && task.tags.length">
                        <span v-for="tag in task.tags" :class="`badge-${taskTags[tag].color}`" class="badge font-weight-normal ml-2">{{taskTags[tag].title}}</span>
                      </span>
          ...
          <b-tab title="Discussion">
            <b-card-body>
              ...
              <div v-for="message in projectData.discussion" class="media mb-3">
                <div>
                  <img :src="`/static/img/avatars/${message.user.avatar}`" class="ui-w-40 rounded-circle" alt>
          ...
          <b-tab title="Activity">
            <b-card-body>
              ...
              <div v-for="activity in projectData.activities" class="media pb-1 mb-3">
                <div class="ui-feed-icon-container">
                  ...
                  <img :src="`/static/img/avatars/${activity.user.avatar}`" class="ui-w-40 rounded-circle" alt>
                </div>
      ...
      <div class="col-md-4 col-xl-3">
          ...
          <b-list-group :flush="true">
            ...
            <b-list-group-item v-if="projectData.tags && projectData.tags.length">
              ...
              <div class="d-flex flex-wrap">
                <div v-for="tag in projectData.tags" class="badge badge-default mt-1 mr-1">{{tag}}</div>
              </div>
            </b-list-group-item>
          </b-list-group>
        </b-card>
        ...
        <b-card no-body class="mb-4">
          ...
          <b-list-group :flush="true">
            <div v-for="leader in projectData.leaders" class="list-group-item">
              <div class="media align-items-center">
                <img :src="`/static/img/avatars/${leader.avatar}`" class="d-block ui-w-30 rounded-circle" alt="">
        ...
        <b-card no-body class="mb-4">
          ...
          <b-list-group :flush="true">
            <li v-for="member in projectData.team" class="list-group-item">
              <div class="media align-items-center">
                <img :src="`/static/img/avatars/${member.avatar}`" class="d-block ui-w-30 rounded-circle" alt="">
                <div class="media-body px-2">
...
export default {
  ...
  data: () => ({
    ...
    projectData: {
      ...
      attachments: [
        { name: 'image_1.jpg', size: '527KB', path: '/static/img/bg/5.jpg' },
        { name: 'image_2.jpg', size: '269KB', path: '/static/img/bg/6.jpg' },
