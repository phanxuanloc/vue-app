<template>
  <div>
    ...
    <div class="row">
      <div v-for="course in coursesData" class="col-sm-6 col-xl-4">

        <b-card no-body class="mb-4">
          <div class="w-100">
            <a href="javascript:void(0)" class="card-img-top d-block ui-rect-60 ui-bg-cover" :style="{'background-image': `url('/static/img/bg/${course.image}')`}">
              <div class="d-flex justify-content-between align-items-end ui-rect-content p-3">
                <div class="flex-shrink-1">
                  <span v-for="tag in course.tags" class="badge badge-primary mr-1">{{tag}}</span>
                </div>
