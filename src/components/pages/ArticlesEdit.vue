  ...
  <div>
    ...
    <b-card no-body>
      <b-card-body class="media align-items-center">
        ...
        <img :src="`/static/img/avatars/${articleData.author.avatar}`" class="d-block ui-w-40 rounded-circle" alt="">
      ...
      <b-card-body class="pb-2">
        ...
        <b-form-group label="Content">
          <quill-editor v-model="articleData.content" :options="editorOptions" v-if="!isIE10" />
          <!-- Fallback -->
          <b-textarea v-model="articleData.content" style="height: 400px" v-if="isIE10" />
        </b-form-group>

        <div class="form-group media" style="min-height:1px">
          <div class="ui-bg-cover" style="width: 100px;height: 100px" :style="{'background-image': `url('/static/img/bg/${articleData.main_image}')`}"></div>
          <div class="media-body ml-3">
