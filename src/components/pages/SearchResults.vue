  ...
  <div>
    ...
    <div v-if="curTab === 'pages'">
      ...
      <b-card no-body>
        <b-list-group :flush="true">
          ...
          <li v-for="page in searchData.pages" class="list-group-item py-4">
            ...
            <div v-if="page.sublinks" class="ui-bordered px-3 pt-3 mt-3">
              <div class="row">
                <div v-for="sublink in page.sublinks" class="col-sm-6 col-md-4 pb-3">
    ...
    <div v-if="curTab === 'people'">
      ...
      <div class="row">
        ...
        <div v-for="user in searchData.people" class="col-md-6 col-xl-4">
          <b-card class="card-condenced mb-4" body-class="media align-items-center">
            <img :src="`/static/img/avatars/${user.avatar}`" alt="" class="ui-w-40 rounded-circle">
    ...
    <div v-if="curTab === 'images'">
      ...
      <div class="form-row">
        ...
        <div v-for="image in searchData.images" class="col-sm-6 col-xl-4 mb-2">
          <a href="javascript:void(0)" class="ui-rect-60 ui-bg-cover ui-bg-overlay-container text-white" :style="{'background-image': `url('${image.path}')`}">
    ...
    <div v-if="curTab === 'videos'">
      ...
      <div class="row">
        ...
        <div v-for="video in searchData.videos" class="col-sm-6 col-md-4 col-xl-3 mb-4">
          <a href="javascript:void(0)" class="ui-rect-60 ui-bg-cover text-white" :style="{'background-image': `url('${video.preview}')`}">
