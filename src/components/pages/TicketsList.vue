    ...
    <div class="ui-bordered px-4 pt-4 mb-4">
      <div class="form-row align-items-center">
        ...
        <div class="col-md mb-4">
          ...
          <flat-pickr v-model="filterCreatedDate" :config="{ altInput: true, animate: !isRTL, dateFormat: 'm/d/Y', altFormat: 'm/d/Y', mode: 'range' }" :placeholder="!isIE ? 'Any' : null" />
        </div>
...
export default {
  ...
  data: () => ({
    // Options
    dataUrl: '/static/json/pages_tickets_list.json',
