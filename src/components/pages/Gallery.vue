...
export default {
  ...
  data: () => ({
    ...
    originalGalleryImages: [
      { url: '/static/img/bg/1.jpg', altText: '', tag: 'nature' },
      { url: '/static/img/bg/2.jpg', altText: '', tag: 'car' },
      { url: '/static/img/bg/3.jpg', altText: '', tag: 'other' },
      { url: '/static/img/bg/4.jpg', altText: '', tag: 'other' },
      { url: '/static/img/bg/5.jpg', altText: '', tag: 'other' },
      { url: '/static/img/bg/6.jpg', altText: '', tag: 'nature' },
      { url: '/static/img/bg/7.jpg', altText: '', tag: 'nature' },
      { url: '/static/img/bg/8.jpg', altText: '', tag: 'car' },
      { url: '/static/img/bg/9.jpg', altText: '', tag: 'animal' },
      { url: '/static/img/bg/10.jpg', altText: '', tag: 'animal' },
      { url: '/static/img/bg/11.jpg', altText: '', tag: 'other' },
      { url: '/static/img/bg/12.jpg', altText: '', tag: 'other' },
      { url: '/static/img/bg/13.jpg', altText: '', tag: 'nature' },
      { url: '/static/img/bg/14.jpg', altText: '', tag: 'animal' },
      { url: '/static/img/bg/15.jpg', altText: '', tag: 'other' },
      { url: '/static/img/bg/16.jpg', altText: '', tag: 'other' }
    ],
    galleryOptions: {
      // =======================================================================
  ...
  computed: {
    galleryImages () {
      if (this.curTag === 'all') return this.originalGalleryImages.slice(0)

      return this.originalGalleryImages.filter(img => img.tag === this.curTag)
    },
    galleryImageLinks () {
