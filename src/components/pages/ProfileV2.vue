    ...
    <div class="row">
      <div class="col-xl-4">
        ...
        <b-card no-body class="mb-4">
          <b-card-body>
            <div class="media">
              <img src="/static/img/avatars/5.png" alt class="ui-w-60 rounded-circle">
              <div class="media-body pt-2 ml-3">
                ...
                <div class="mt-3">
                  <b-btn variant="primary btn-round" size="sm">+&nbsp; Follow</b-btn> &nbsp;
                  <b-btn variant="default icon-btn md-btn-flat btn-round" size="sm"><i class="ion ion-md-mail"></i></b-btn> &nbsp;
                </div>
              </div>
            </div>
          </b-card-body>
        ...
        <!-- Links -->
        <b-card class="mb-4" header="Links">
          <div class="media align-items-center pb-1 mb-3">
            <img src="/static/img/uikit/logo-5.png" class="d-block ui-w-40 rounded-circle" alt>
          ...
          <div class="media align-items-center pb-1 mb-3">
            <img src="/static/img/uikit/logo-6.png" class="d-block ui-w-40 rounded-circle" alt>
            <div class="media-body flex-truncate ml-3">
          ...
          <div class="media align-items-center pb-1 mb-3">
            <img src="/static/img/uikit/logo-7.png" class="d-block ui-w-40 rounded-circle" alt>
            <div class="media-body flex-truncate ml-3">
          ...
          <div class="media align-items-center">
            <img src="/static/img/uikit/logo-8.png" class="d-block ui-w-40 rounded-circle" alt>
            <div class="media-body flex-truncate ml-3">
        ...
        <!-- Friends -->
        <b-card class="mb-4" header="Friends">
          <div class="media align-items-center pb-1 mb-3">
            <img src="/static/img/avatars/2-small.png" class="d-block ui-w-40 rounded-circle" alt>
            <div class="media-body ml-3">
              <a href="javascript:void(0)" class="text-dark">Leon Wilson</a>
              <div class="text-muted small">@lwilson</div>
            </div>
            <b-btn variant="default md-btn-flat" size="sm" class="d-block">Follow</b-btn>
          </div>

          <div class="media align-items-center pb-1 mb-3">
            <img src="/static/img/avatars/3-small.png" class="d-block ui-w-40 rounded-circle" alt>
            <div class="media-body ml-3">
              <a href="javascript:void(0)" class="text-dark">Allie Rodriguez</a>
              <div class="text-muted small">@arodriguez</div>
            </div>
            <b-btn variant="success" size="sm" class="d-block"><i class="ion ion-md-checkmark"></i> Following</b-btn>
          </div>
          ...
          <div class="media align-items-center pb-1 mb-3">
            <img src="/static/img/avatars/1-small.png" class="d-block ui-w-40 rounded-circle" alt>
            <div class="media-body ml-3">
