<template>
  ...
  <div class="messages-wrapper" :class="{'messages-sidebox-open': sideboxOpen}">
    ...
    <perfect-scrollbar :options="{ suppressScrollX: true, wheelPropagation: true }" class="messages-sidebox messages-scroll">
      ...
      <!-- Mail boxes -->
      <a v-for="(box, boxId) in mailBoxes" href="javascript:void(0)" class="d-flex justify-content-between align-items-center py-2 px-4" :class="{'font-weight-bold text-dark': currentMailBox === boxId, 'text-muted': currentMailBox !== boxId}">
      ...
      <a v-for="label in labels" href="javascript:void(0)" class="d-block text-muted py-1 px-4">
      ...
      <div class="flex-grow-1 position-relative">
        ...
        <perfect-scrollbar :options="{ suppressScrollX: true, wheelPropagation: true }" class="messages-content messages-scroll">
          ...
          <div class="container-p-x pt-4 pb-2" v-if="messageData.attachments && messageData.attachments.length">
            ...
            <div class="row">
              <div v-for="attachment in messageData.attachments" class="col-sm-6 col-md-4 col-lg-6 col-xl-4">

                <div class="message-attachment ui-bordered p-2 mr-3 mb-3">

                  <div v-if="isImage(attachment)" :style="{'background-image': `url(${attachment.path})`}" class="message-attachment-img"></div>
...
export default {
  ...
  data: () => ({
    ...
    messageData: {
      ...
      sender: {
        avatar: '/static/img/avatars/6-small.png',
        name: 'Mae Gibson',
