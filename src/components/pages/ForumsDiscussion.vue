  ...
  <div>
    ...
    <h4 class="d-flex flex-wrap justify-content-between align-items-center pt-3 mb-4">
      <div class="mb-3">
        ...
        <span v-for="tag in discussionData.tags"> <small><span class="badge align-text-bottom ml-1" :class="'badge-' + tags[tag].color">{{tags[tag].title}}</span></small></span>
      </div>
    ...
    <b-card class="mb-4" footer-class="pt-0 px-0 pb-3">
      <div class="media flex-wrap align-items-center" slot="header">
        <img :src="`/static/img/avatars/${discussionData.author.avatar}`" class="d-block ui-w-40 rounded-circle" alt>
    ...
    <div v-for="reply in discussionData.replies">
      <b-card class="mb-3">

        <div class="media">
          <img :src="`/static/img/avatars/${reply.author.avatar}`" alt class="d-block ui-w-40 rounded-circle">
