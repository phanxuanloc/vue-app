<template>
  <div>
    ...
    <div class="row">
      <div v-for="team in teamsData" class="col-sm-6 col-xl-4">
        ...
        <b-card no-body class="mb-4">
          ...
          <b-card-body class="pt-3 pb-0">
            ...
            <div class="d-flex flex-wrap">
              <a v-for="leader in team.leaders" href="javascript:void(0)" class="d-block mr-1 mb-1"><img :src="`/static/img/avatars/${leader.avatar}`" alt="" class="ui-w-30 rounded-circle"></a>
            </div>
          </b-card-body>
          <b-card-body class="py-3">
            <div class="text-muted small mb-2">Members</div>
            <div class="d-flex flex-wrap">
              <a v-for="member in team.members" href="javascript:void(0)" class="d-block mr-1 mb-1"><img :src="`/static/img/avatars/${member.avatar}`" alt="" class="ui-w-30 rounded-circle"></a>
            </div>
          </b-card-body>
          <hr class="m-0">
