<template>
  <div>
    ...
    <b-card no-body class="mb-3">
      ...
      <div v-for="(thread, index) in threadsData">
          ...
          <div class="row no-gutters align-items-center">
            <div class="col">
              ...
              <span v-if="thread.tags && thread.tags.length">
                <span v-for="tag in thread.tags" :class="`badge-${tags[tag].color}`" class="badge align-text-bottom ml-1">{{tags[tag].title}}</span>
              </span>
              <div class="text-muted small mt-1">Started {{thread.startedAt}} ago &nbsp;·&nbsp; <a href="javascript:void(0)" class="text-muted">{{thread.startedBy}}</a></div>
            </div>
            <div class="d-none d-md-block col-4">
              ...
              <div class="row no-gutters align-items-center">
                ...
                <div class="media col-8 align-items-center">
                  <img :src="`/static/img/avatars/${thread.lastUpdate.user.avatar}`" alt="" class="d-block ui-w-30 rounded-circle">
