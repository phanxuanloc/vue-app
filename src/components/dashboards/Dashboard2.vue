          ...
          <b-card-body>
            <div class="media pb-1 mb-3">
              <div class="ui-feed-icon-container">
                ...
                <img src="/static/img/avatars/7-small.png" class="ui-w-40 rounded-circle" alt>
              </div>
            ...
            <div class="media pb-1 mb-3">
              <div class="ui-feed-icon-container">
                ...
                <img src="/static/img/avatars/8-small.png" class="ui-w-40 rounded-circle" alt>
              </div>
              <div class="media-body align-self-center ml-3">
            ...
            <div class="media pb-1 mb-3">
              <div class="ui-feed-icon-container">
                ...
                <img src="/static/img/avatars/9-small.png" class="ui-w-40 rounded-circle" alt>
              </div>
              <div class="media-body align-self-center ml-3">
            ...
            <div class="media">
              <div class="ui-feed-icon-container">
                ...
                <img src="/static/img/avatars/11-small.png" class="ui-w-40 rounded-circle" alt>
              </div>
              <div class="media-body align-self-center ml-3">
