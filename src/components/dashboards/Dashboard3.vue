<template>
  <div>
    <h4 class="d-flex justify-content-between align-items-center py-2 mb-4">
      ...
      <b-btn variant="outline-primary" class="btn-round">View reports</b-btn>
    </h4>
    ...
    <div class="row">
      ...
      <div class="col-md-7 col-lg-12 col-xl-7">
        ...
        <b-card no-body class="mb-4">
          <b-card-header header-tag="h6">Popular products</b-card-header>
              ...
              <tbody>
                <tr>
                  <td class="align-middle" style="width: 75px">
                    <img class="ui-w-40" src="/static/img/uikit/ps4.jpg" alt>
                  </td>
                ...
                <tr>
                  <td class="align-middle">
                    <img class="ui-w-40" src="/static/img/uikit/nike-1.jpg" alt>
                  </td>
                  <td class="align-middle">
                ...
                <tr>
                  <td class="align-middle">
                    <img class="ui-w-40" src="/static/img/uikit/headphones.jpg" alt>
                  </td>
                  <td class="align-middle">
                ...
                <tr>
                  <td class="align-middle">
                    <img class="ui-w-40" src="/static/img/uikit/backpack.jpg" alt>
                  </td>
                  <td class="align-middle">
                ...
                <tr>
                  <td class="align-middle">
                    <img class="ui-w-40" src="/static/img/uikit/chair-1.jpg" alt>
                  </td>
                  <td class="align-middle">
      ...
      <div class="col-md-6">
        ...
        <!-- Latest comments -->
        <b-card no-body class="mb-4">
          <b-card-header header-tag="h6">Latest comments</b-card-header>
          <b-card-body>

            <div class="media pb-1 mb-3">
              <img src="/static/img/avatars/9-small.png" class="d-block ui-w-40 rounded-circle" alt>
            ...
            <div class="media pb-1 mb-3">
              <img src="/static/img/avatars/8-small.png" class="d-block ui-w-40 rounded-circle" alt>
              <div class="media-body flex-truncate ml-3">
            ...
            <div class="media pb-1 mb-3">
              <img src="/static/img/avatars/7-small.png" class="d-block ui-w-40 rounded-circle" alt>
              <div class="media-body flex-truncate ml-3">
...
Vue.component('dashboard3-chart1', {
...
Vue.component('dashboard3-chart2', {
  extends: VueChartJs.Line,
  mounted () {
    this.renderChart({
      datasets: [{
...
Vue.component('dashboard3-chart3', {
  extends: VueChartJs.Line,
  mounted () {
    this.renderChart({
      datasets: [{
...
Vue.component('dashboard3-chart4', {
  extends: VueChartJs.Line,
  mounted () {
    this.renderChart({
      datasets: [{
...
export default {
  ...
  mounted () {
    ...
    this.layoutHelpers.on('resize.dashboard-3', resizeCharts)
  },
  beforeDestroy () {
    this.layoutHelpers.off('resize.dashboard-3')
  }
}
</script>
