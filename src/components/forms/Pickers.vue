<template>
  <div>
    ...
    <b-card header="Vue Flatpickr Component" header-tag="h6" class="mb-4">
      <div class="demo-vertical-spacing">
        <flat-pickr v-model="date" :config="dateConfig" :placeholder="!isIE ? 'Date picker' : null" />
        <flat-pickr v-model="time" :config="timeConfig" :placeholder="!isIE ? 'Time picker' : null" />
        <flat-pickr v-model="datetime" :config="datetimeConfig" :placeholder="!isIE ? 'Datetime picker' : null" />
        <flat-pickr v-model="full" :config="fullConfig" :placeholder="!isIE ? 'Features' : null" />
        <flat-pickr v-model="range" :config="rangeConfig" :placeholder="!isIE ? 'Range picker' : null" />
        <div>
          <flat-pickr v-model="inline" :config="inlineConfig" :placeholder="!isIE ? 'Inline datepicker' : null" input-class="d-none" />
        </div>
      </div>
    </b-card>
